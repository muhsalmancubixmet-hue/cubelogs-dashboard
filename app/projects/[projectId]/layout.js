...
export default function SingleProjectLayout({ children }) {
  ...
  useEffect(() => {
    if (!projectId) return;
    try {
      localStorage.setItem('cubelogs_active_project_id', String(projectId));
    } catch (e) {}
    let isMounted = true;
  ...
  return (
    <PageWrapper title={project?.name ? `Project Management - ${project.name}` : "Project Management"} requiredPermission={['projects:view', 'projects.overview.view', 'projects.board.view', 'projects.my_tasks.view', 'projects.backlog.view', 'projects.sprint.view', 'projects.story.view', 'projects.task.view']}>
      <div className="single-project-workspace-wrapper">
        <div style={{ marginBottom: 20 }}>
          {/* Breadcrumb Header */}
          <div className="project-workspace-breadcrumb" style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: '#64748b', marginBottom: 12, flexWrap: 'wrap' }}>
          ...
          <div className="project-workspace-header" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              <div className="project-workspace-icon-box" style={{
                width: 44,
                height: 44,
                borderRadius: 12,
                background: '#eff6ff',
          ...
          <div className="project-workspace-tabs" style={{
            display: 'flex',
            gap: 4,
            ...
            {tabs.map((tab) => {
              ...
              return (
                <Link
                  ...
                  className={active ? "project-tab-link active" : "project-tab-link"}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: 8,
        ...
        {isRestrictedRoute ? (
          ...
          <div className="single-project-workspace-body">
            {children}
          </div>
        )}
      </div>
